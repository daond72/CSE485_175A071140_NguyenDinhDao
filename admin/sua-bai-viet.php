                ...
                <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                ...
                                                <div class="form-line">
                                                    <img src="<?php echo $tenhinhanh; ?>" style="width: 100px; height: 80px;"> <br>
...
if(isset($_POST['delete'])) {
   ...
   $idtintuc =  $_POST['idtintuc'];
    $delete = $con->prepare("DELETE FROM tintuc WHERE idtintuc = '$idtintuc'");
    $delete->execute();
     echo '<script>window.location.href=("tat-ca-bai-viet.php");</script>'; // chuyển trang
 }
    ?>
